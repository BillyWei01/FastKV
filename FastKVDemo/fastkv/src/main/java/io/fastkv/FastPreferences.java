...
/**
 * Wrap FastKV to support SharedPreferences API.
 * This class not support multiprocess, be care not to access with multi processes.
 * You could use {@link MPFastKV} to support multiprocess.
 */
